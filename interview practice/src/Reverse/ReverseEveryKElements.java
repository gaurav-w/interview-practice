...
class ReverseEveryKElements {
    ...
    public static ListNode reverse(ListNode head, int k) {
        ...
        ListNode curr = null;
        ListNode prev = null;
        ListNode prevSubListLast = null;
        ListNode nextNode = null;
        ListNode firstListHead = null;

        while (temp != null) {
            sublistHead = null; //it is head of reversed sublist
            sublistTail = temp; // it is last of sublist
            curr = temp;
            ...
            if (firstListHead == null) {
                firstListHead = sublistHead;
            }

            if (prevSubListLast != null)
                prevSubListLast.next = sublistHead;

            prevSubListLast = sublistTail;
